...
const ChangeOOScreen = ({ navigation }) => {
  ...
  <View style={styles.container}>
    ...
    <Text style={styles.heading}>A-2. Organisation's Proxy/Representative</Text>
    <View style={styles.inputContainer}>
        <Text style={styles.label}>Type of Identification:</Text>
        <Picker
          selectedValue={ownerIdentificationType}
    ...
    />
        ...
        {/* Input fields for proxy/representative details */}
    <Text style={styles.heading}>B-2. Organisation's Proxy/Representative</Text>
    <View style={styles.inputContainer}>
        <Text style={styles.label}>Type of Identification:</Text>
        <Picker
          selectedValue={ownerIdentificationType}
    ...
    <TextInput
      style={styles.input}
      placeholder="Identification Number"
      value={newProxyIdentificationNumber}
      onChangeText={setNewProxyIdentificationNumber}
    />
    <TextInput
      style={styles.input}
      placeholder="Full Name"
      value={newProxyFullName}
      onChangeText={setNewProxyFullName}
    />
